...
import { AjustecontableService } from 'src/app/servicios/ajustecontable.service';
...
export class AjustecontableComponent {
  ...
  constructor(private router: Router, private scuentas: CuentasService, private sproveedor: ProveedorService, private sajuste: AjustecontableService) {}
  ...
  calcularTotales(): void {
    this.totalDebito = this.obj_ajustecontable.debito + this.obj_ajustecontable.debito2;
    this.totalCredito = this.obj_ajustecontable.credito + this.obj_ajustecontable.credito2;
  ...
  //---------------Función de validar-------------------------------------------------------------------------------------------------------
  validar(){
    this.obj_ajustecontable.total_debito = this.totalDebito;
    this.obj_ajustecontable.total_credito = this.totalCredito;
    this.obj_ajustecontable.fo_usuario= this.id;
  ...
  escoger(itemc: any): void {//Función escoger la cuenta
    ...
    this.obj_ajustecontable.fo_cuenta = itemc.id_cuenta;
    this.obj_ajustecontable.fo_codigo = itemc.id_cuenta;
  ...
  escoger2(itemc2: any): void {//Función escoger la cuenta
    ...
    this.obj_ajustecontable.fo_cuenta2 = itemc2.id_cuenta;
    this.obj_ajustecontable.fo_codigo2 = itemc2.id_cuenta;
  ...
  escogerpro(itempro: any): void {//Función escoger el cliente
    ...
    this.obj_ajustecontable.fo_proveedor = itempro.id_proveedor;
  ...
  escogerpro2(itempro2: any): void {//Función escoger el cliente
    ...
    this.obj_ajustecontable.fo_proveedor2 = itempro2.id_proveedor;
